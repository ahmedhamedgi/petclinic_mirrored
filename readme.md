...
You can then acceswwws petclinic here: http://localhost:8080/
...
[spring-petclinic-rest]: https://github.com/spring-petclinic/spring-petclinic-rest ss
pr to dev from feature
